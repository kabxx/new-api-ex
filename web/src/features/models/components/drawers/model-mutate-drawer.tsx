...
export function ModelMutateDrawer({
  ...
  const modelSettings = useMemo(() => {
    ...
    const defaultModelSettings: ModelSettings = {
      ...
      'retry_setting.same_priority_strategy': 'weighted_random',
      ...
      'monitor_setting.auto_disable_rate_sample_size': 20,
      'monitor_setting.auto_disable_rate_min_samples': 10,
      'monitor_setting.auto_disable_rate_threshold_percent': 60,
